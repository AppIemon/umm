...
import { _ as __nuxt_component_0$1 } from './GameCanvas-BsmqE8-y.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "song-selector" }, _attrs))} data-v-b8d599b0><div class="tabs" data-v-b8d599b0><button class="${ssrRenderClass({ active: mode.value === "samples" })}" data-v-b8d599b0>SAMPLES</button><button class="${ssrRenderClass({ active: mode.value === "upload" })}" data-v-b8d599b0>UPLOAD</button><button class="${ssrRenderClass({ active: mode.value === "youtube" })}" data-v-b8d599b0>GUIDE</button><button class="${ssrRenderClass({ active: mode.value === "storage" })}" data-v-b8d599b0>RECENT</button></div>`);
      if (mode.value === "samples") {
        _push(`<div class="tab-content" data-v-b8d599b0><p class="section-desc" data-v-b8d599b0>CC0 무료 음악 - 저작권 걱정 없이 바로 플레이!</p><div class="sample-list" data-v-b8d599b0><!--[-->`);
        ssrRenderList(sampleTracks.value, (sample) => {
          _push(`<div class="${ssrRenderClass([{ selected: selectedSample.value?.id === sample.id, loading: loadingSampleId.value === sample.id }, "sample-item"])}" data-v-b8d599b0><div class="sample-info" data-v-b8d599b0><span class="sample-name" data-v-b8d599b0>${ssrInterpolate(sample.name)}</span><span class="sample-meta" data-v-b8d599b0>${ssrInterpolate(sample.genre)} • ${ssrInterpolate(sample.duration)}</span></div>`);
          if (loadingSampleId.value === sample.id) {
            _push(`<span class="loading-indicator" data-v-b8d599b0>◆</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(`<div class="tab-content" data-v-b8d599b0><div class="drop-zone" data-v-b8d599b0>`);
        if (!selectedFile.value) {
          _push(`<p data-v-b8d599b0>DROP FILE HERE</p>`);
        } else {
          _push(`<p class="highlight" data-v-b8d599b0>${ssrInterpolate(selectedFile.value.name)}</p>`);
        }
        _push(`</div><input type="file" accept="audio/*" style="${ssrRenderStyle({ "display": "none" })}" data-v-b8d599b0></div>`);
      } else if (mode.value === "youtube") {
        _push(`<div class="tab-content" data-v-b8d599b0><div class="youtube-guide" data-v-b8d599b0><h3 class="guide-title" data-v-b8d599b0>🎵 YouTube MP3 변환 가이드</h3><p class="guide-desc" data-v-b8d599b0>저작권 보호를 위해 직접 다운로드 기능이 제거되었습니다.<br data-v-b8d599b0>아래 방법으로 MP3 파일을 준비해주세요.</p><div class="guide-steps" data-v-b8d599b0><div class="step" data-v-b8d599b0><span class="step-num" data-v-b8d599b0>1</span><div class="step-content" data-v-b8d599b0><strong data-v-b8d599b0>YouTube 영상 URL 복사</strong><p data-v-b8d599b0>원하는 음악 영상의 주소를 복사하세요</p></div></div><div class="step" data-v-b8d599b0><span class="step-num" data-v-b8d599b0>2</span><div class="step-content" data-v-b8d599b0><strong data-v-b8d599b0>MP3 변환 사이트 이용</strong><p data-v-b8d599b0>아래 사이트에서 MP3로 변환하세요</p><div class="converter-links" data-v-b8d599b0><a href="https://y2mate.com" target="_blank" rel="noopener" class="converter-link" data-v-b8d599b0><span class="link-icon" data-v-b8d599b0>🔗</span> Y2Mate </a><a href="https://ytmp3.cc" target="_blank" rel="noopener" class="converter-link" data-v-b8d599b0><span class="link-icon" data-v-b8d599b0>🔗</span> YTMP3 </a><a href="https://loader.to" target="_blank" rel="noopener" class="converter-link" data-v-b8d599b0><span class="link-icon" data-v-b8d599b0>🔗</span> Loader.to </a></div></div></div><div class="step" data-v-b8d599b0><span class="step-num" data-v-b8d599b0>3</span><div class="step-content" data-v-b8d599b0><strong data-v-b8d599b0>MP3 파일 업로드</strong><p data-v-b8d599b0>다운로드한 MP3 파일을 UPLOAD 탭에서 업로드하세요</p><button class="go-upload-btn" data-v-b8d599b0>UPLOAD 탭으로 이동 →</button></div></div></div><div class="warning-box" data-v-b8d599b0><span class="warning-icon" data-v-b8d599b0>⚠️</span><p data-v-b8d599b0>이상한 스팸 사이트가 나올 수도 있으니 자동으로 열리는 사이트는 바로 닫아주세요.<br data-v-b8d599b0>2번정도 닫으면 다운로드가 됩니다.</p></div></div></div>`);
      } else if (mode.value === "storage") {
        _push(`<div class="tab-content" data-v-b8d599b0><p class="section-desc" data-v-b8d599b0>최근 사용한 노래 (최대 20곡)</p>`);
        if (recentSongs.value.length > 0) {
          _push(`<div class="storage-list" data-v-b8d599b0><!--[-->`);
          ssrRenderList(recentSongs.value, (song) => {
            _push(`<div class="${ssrRenderClass([{ selected: selectedRecentSong.value?.id === song.id }, "storage-item"])}" data-v-b8d599b0><div class="song-info" data-v-b8d599b0><span class="name" data-v-b8d599b0>${ssrInterpolate(song.name)}</span><span class="date" data-v-b8d599b0>${ssrInterpolate(formatDate(song.addedAt))}</span></div><button class="delete-btn" data-v-b8d599b0>✕</button></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<div class="empty-state" data-v-b8d599b0><p class="empty-icon" data-v-b8d599b0>📁</p><p class="empty-msg" data-v-b8d599b0>최근 사용한 노래가 없습니다</p><p class="empty-hint" data-v-b8d599b0>UPLOAD 탭에서 노래를 추가하면 여기에 기록됩니다</p></div>`);
        }
        if (recentSongs.value.length > 0) {
          _push(`<button class="clear-all-btn" data-v-b8d599b0> 전체 삭제 </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<button class="confirm-btn"${ssrIncludeBooleanAttr(!canConfirm.value) ? " disabled" : ""} data-v-b8d599b0> SELECT </button></div>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-b8d599b0"]]), { __name: "SongSelector" });
...
class SmartMapGenerator {
  ...
  async generate(audioBuffer, mapData) {
    try {
      ...
      while (bestMatchRate < 0.975 && attempt < MAX_ATTEMPTS) {
        this.setStatus("adjusting_path", 30 + attempt / MAX_ATTEMPTS * 30, `Attempt ${attempt + 1}: Simulating...`);
  ...
  calculateMatchRate(path, beats) {
    ...
    for (const beat of beats) {
      if (actions.some((a) => Math.abs(a - beat) < window)) {
        matched++;
      }
    }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "play-page" }, _attrs))} data-v-4c531971><div class="background-anim" data-v-4c531971></div>`);
      if (step.value === "upload") {
        _push(`<div class="setup-container" data-v-4c531971>`);
        if (isAnalyzing.value) {
          _push(`<div class="processing-overlay" data-v-4c531971><div class="loader-content" data-v-4c531971><div class="wave-loader" data-v-4c531971>◆</div><h2 data-v-4c531971>${ssrInterpolate(analysisProgress.value.step || "맵 생성 중...")}</h2><div class="progress-bar" data-v-4c531971><div class="fill" style="${ssrRenderStyle({ width: analysisProgress.value.percent + "%", animation: "none" })}" data-v-4c531971></div></div>`);
          if (timeLeft.value > 0) {
            _push(`<p class="time-left" data-v-4c531971>예상 남은 시간: 약 ${ssrInterpolate(Math.ceil(timeLeft.value))}초</p>`);
          } else if (analysisProgress.value.percent > 0) {
            _push(`<p data-v-4c531971>거의 다 되었습니다...</p>`);
          } else {
            _push(`<!---->`);
          }
          if (validationFailure.value) {
            _push(`<div class="failure-log" data-v-4c531971><span class="fail-tag" data-v-4c531971>CRITICAL BLOCKAGE AT ${ssrInterpolate(validationFailure.value.x)}</span><canvas width="300" height="150" class="fail-preview" data-v-4c531971></canvas><div class="fail-details" data-v-4c531971> AI failed to find a path through this section. </div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
        ...
        _push(`<div class="header-icon" data-v-4c531971>◆</div><h1 class="title" data-v-4c531971>ULTRA MUSIC MANIA</h1>`);
        if (!loadedMapData.value) {
          _push(`<p class="desc" data-v-4c531971>음악 파일을 선택하면 자동으로 맵이 생성됩니다</p>`);
        } else {
          _push(`<p class="desc map-notice" data-v-4c531971> 로드된 맵: <strong data-v-4c531971>${ssrInterpolate(loadedMapData.value.title)}</strong><br data-v-4c531971> 게임을 시작하려면 이 맵에 사용된 노래 파일을 선택해주세요. </p>`);
        }
        _push(ssrRenderComponent(_component_SongSelector, { onSelect: handleSongSelect }, null, _parent));
        _push(`<div class="difficulty-select" data-v-4c531971><div class="diff-header" data-v-4c531971><label data-v-4c531971>난이도 설정:</label><span class="diff-value" style="${ssrRenderStyle({ color: getDifficultyColor(difficulty.value) })}" data-v-4c531971>${ssrInterpolate(difficultyName.value)} (${ssrInterpolate(difficulty.value)}) </span></div><div class="slider-container" data-v-4c531971><input type="range" min="1" max="30"${ssrRenderAttr("value", difficulty.value)} class="diff-slider" data-v-4c531971><div class="slider-marks" data-v-4c531971><span data-v-4c531971>EASY</span><span data-v-4c531971>NORMAL</span><span data-v-4c531971>HARD</span><span data-v-4c531971>INSANE</span></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (step.value === "smart_gen") {
        _push(`<div class="setup-container" data-v-4c531971><div class="processing-overlay" data-v-4c531971><div class="loader-content" data-v-4c531971><div class="wave-loader" data-v-4c531971>✨</div><h2 data-v-4c531971>SMART GENERATION</h2><div class="progress-bar" data-v-4c531971><div class="fill" style="${ssrRenderStyle({ width: smartGenProgress.value + "%" })}" data-v-4c531971></div></div><p class="status-detail" data-v-4c531971>${ssrInterpolate(smartGenStatus.value.toUpperCase().replace("_", " "))}</p><div class="smart-gen-logs" data-v-4c531971><!--[-->`);
        ssrRenderList(smartGenLog.value.slice(-5), (log, i) => {
          _push(`<div class="log-entry" data-v-4c531971>${ssrInterpolate(log)}</div>`);
        });
      ...
      if (showModeSelect.value) {
        _push(`<div class="mode-modal-overlay" data-v-4c531971><div class="mode-modal glass-panel" data-v-4c531971><div class="mode-header-row" data-v-4c531971><h2 data-v-4c531971>SELECT GAME MODE</h2><button class="debug-btn" title="View Map Logic" data-v-4c531971> 🔍 Map Logic </button></div><div class="mode-options" data-v-4c531971><button class="mode-btn practice" data-v-4c531971><div class="mode-icon" data-v-4c531971>🛠️</div><h3 data-v-4c531971>PRACTICE MODE</h3><p data-v-4c531971>체크포인트 사용 가능<br data-v-4c531971>기록 미저장</p></button><button class="mode-btn normal" data-v-4c531971><div class="mode-icon" data-v-4c531971>🎵</div><h3 data-v-4c531971>NORMAL MODE</h3><p data-v-4c531971>표준 플레이<br data-v-4c531971>랭킹 기록 저장</p></button><button class="${ssrRenderClass([{ recommended: isFirstTime.value }, "mode-btn tutorial"])}" data-v-4c531971><div class="mode-icon" data-v-4c531971>🎓</div>`);
        if (isFirstTime.value) {
          _push(`<div class="rec-badge" data-v-4c531971>RECOMMENDED</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<h3 data-v-4c531971>TUTORIAL MODE</h3><p data-v-4c531971>게임 가이드<br data-v-4c531971>기초 배우기</p></button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
const play = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4c531971"]]);

export { play as default };
//# sourceMappingURL=play-e1zv_0Ig.mjs.map
