...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const drawMap = () => {
      ...
      if (props.mapData.engineObstacles) {
        ...
        props.mapData.engineObstacles.forEach((obs) => {
          ...
          const w2 = (obs.width ?? 50) * drawScaleX;
          const h2 = (obs.height ?? 50) * drawScaleY;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "map-preview-modal-overlay" }, _attrs))} data-v-5256e216><div class="map-preview-modal glass-panel" data-v-5256e216><div class="modal-header" data-v-5256e216><h2 data-v-5256e216>MAP VISUALIZATION LOGIC</h2><div class="legend" data-v-5256e216><span class="legend-item" data-v-5256e216><span class="color-box note" data-v-5256e216></span> Piano Notes (Beats)</span><span class="legend-item" data-v-5256e216><span class="color-box path" data-v-5256e216></span> Path (Trajectory)</span><span class="legend-item" data-v-5256e216><span class="color-box obstacle" data-v-5256e216></span> Obstacles</span></div><button class="close-btn" data-v-5256e216>×</button></div><div class="preview-viewport" data-v-5256e216><div class="scroll-container" data-v-5256e216><canvas${ssrRenderAttr("width", canvasWidth.value)}${ssrRenderAttr("height", 720)} data-v-5256e216></canvas></div></div><div class="info-footer" data-v-5256e216><p data-v-5256e216>Total Duration: ${ssrInterpolate(duration.value.toFixed(1))}s</p><p data-v-5256e216>Total Length: ${ssrInterpolate(canvasWidth.value)}px</p></div></div></div>`);
    };
  }
});
...
const MapPreviewModal = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-5256e216"]]), { __name: "MapPreviewModal" });
      ...
      try {
        ...
        for (let i = 0; ; i++) {
          ...
          if (i > 0 && validationFailure.value && lastResumeData) {
            ...
            const safeBuffer = adjustedDifficulty >= 16 ? 15 : 30;
...
문의처: ${contact}`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "play-page" }, _attrs))} data-v-cfb206ea><div class="background-anim" data-v-cfb206ea></div>`);
      if (step.value === "upload") {
        _push(`<div class="setup-container" data-v-cfb206ea>`);
        if (isAnalyzing.value) {
          _push(`<div class="processing-overlay" data-v-cfb206ea><div class="loader-content" data-v-cfb206ea><div class="wave-loader" data-v-cfb206ea>◆</div><h2 data-v-cfb206ea>${ssrInterpolate(analysisProgress.value.step || "맵 생성 중...")}</h2><div class="progress-bar" data-v-cfb206ea><div class="fill" style="${ssrRenderStyle({ width: analysisProgress.value.percent + "%", animation: "none" })}" data-v-cfb206ea></div></div>`);
          if (timeLeft.value > 0) {
            _push(`<p class="time-left" data-v-cfb206ea>예상 남은 시간: 약 ${ssrInterpolate(Math.ceil(timeLeft.value))}초</p>`);
          } else if (analysisProgress.value.percent > 0) {
            _push(`<p data-v-cfb206ea>거의 다 되었습니다...</p>`);
          } else {
            _push(`<!---->`);
          }
          if (validationFailure.value) {
            _push(`<div class="failure-log" data-v-cfb206ea><span class="fail-tag" data-v-cfb206ea>CRITICAL BLOCKAGE AT ${ssrInterpolate(validationFailure.value.x)}</span><canvas width="300" height="150" class="fail-preview" data-v-cfb206ea></canvas><div class="fail-details" data-v-cfb206ea> AI failed to find a path through this section. </div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
        ...
        _push(`<div class="header-icon" data-v-cfb206ea>◆</div><h1 class="title" data-v-cfb206ea>ULTRA MUSIC MANIA</h1>`);
        if (!loadedMapData.value) {
          _push(`<p class="desc" data-v-cfb206ea>음악 파일을 선택하면 자동으로 맵이 생성됩니다</p>`);
        } else {
          _push(`<p class="desc map-notice" data-v-cfb206ea> 로드된 맵: <strong data-v-cfb206ea>${ssrInterpolate(loadedMapData.value.title)}</strong><br data-v-cfb206ea> 게임을 시작하려면 이 맵에 사용된 노래 파일을 선택해주세요. </p>`);
        }
        _push(ssrRenderComponent(_component_SongSelector, { onSelect: handleSongSelect }, null, _parent));
        _push(`<div class="difficulty-select" data-v-cfb206ea><div class="diff-header" data-v-cfb206ea><label data-v-cfb206ea>난이도 설정:</label><span class="diff-value" style="${ssrRenderStyle({ color: getDifficultyColor(difficulty.value) })}" data-v-cfb206ea>${ssrInterpolate(difficultyName.value)} (${ssrInterpolate(difficulty.value)}) </span></div><div class="slider-container" data-v-cfb206ea><input type="range" min="1" max="30"${ssrRenderAttr("value", difficulty.value)} class="diff-slider" data-v-cfb206ea><div class="slider-marks" data-v-cfb206ea><span data-v-cfb206ea>EASY</span><span data-v-cfb206ea>NORMAL</span><span data-v-cfb206ea>HARD</span><span data-v-cfb206ea>INSANE</span></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (step.value === "smart_gen") {
        _push(`<div class="setup-container" data-v-cfb206ea><div class="processing-overlay" data-v-cfb206ea><div class="loader-content" data-v-cfb206ea><div class="wave-loader" data-v-cfb206ea>✨</div><h2 data-v-cfb206ea>SMART GENERATION</h2><div class="progress-bar" data-v-cfb206ea><div class="fill" style="${ssrRenderStyle({ width: smartGenProgress.value + "%" })}" data-v-cfb206ea></div></div><p class="status-text" data-v-cfb206ea>${ssrInterpolate(smartGenStatus.value ? smartGenStatus.value.toUpperCase().replace("_", " ") : "PREPARING...")} (${ssrInterpolate(smartGenProgress.value)}%)</p><div class="smart-gen-logs" data-v-cfb206ea><!--[-->`);
        ssrRenderList(smartGenLogsDisplay.value, (log, i) => {
          _push(`<div class="log-entry" data-v-cfb206ea>${ssrInterpolate(log)}</div>`);
        });
      ...
      if (showModeSelect.value) {
        _push(`<div class="mode-modal-overlay" data-v-cfb206ea><div class="mode-modal glass-panel" data-v-cfb206ea><div class="mode-header-row" data-v-cfb206ea><h2 data-v-cfb206ea>SELECT GAME MODE</h2><button class="debug-btn" title="View Map Logic" data-v-cfb206ea> 🔍 Map Logic </button></div><div class="mode-options" data-v-cfb206ea><button class="mode-btn practice" data-v-cfb206ea><div class="mode-icon" data-v-cfb206ea>🛠️</div><h3 data-v-cfb206ea>PRACTICE MODE</h3><p data-v-cfb206ea>체크포인트 사용 가능<br data-v-cfb206ea>기록 미저장</p></button><button class="mode-btn normal" data-v-cfb206ea><div class="mode-icon" data-v-cfb206ea>🎵</div><h3 data-v-cfb206ea>NORMAL MODE</h3><p data-v-cfb206ea>표준 플레이<br data-v-cfb206ea>랭킹 기록 저장</p></button><button class="${ssrRenderClass([{ recommended: isFirstTime.value }, "mode-btn tutorial"])}" data-v-cfb206ea><div class="mode-icon" data-v-cfb206ea>🎓</div>`);
        if (isFirstTime.value) {
          _push(`<div class="rec-badge" data-v-cfb206ea>RECOMMENDED</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<h3 data-v-cfb206ea>TUTORIAL MODE</h3><p data-v-cfb206ea>게임 가이드<br data-v-cfb206ea>기초 배우기</p></button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
const play = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cfb206ea"]]);

export { play as default };
//# sourceMappingURL=play-D46757xs.mjs.map
