...
import { w as hasProtocol, x as isScriptProtocol, y as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch$1, C as createHooks, D as executeAsync, f as createError$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "maps",
    path: "/maps",
    component: () => import('./maps-Ca1g0v1R.mjs')
  },
  {
    name: "play",
    path: "/play",
    meta: __nuxt_page_meta || {},
    component: () => import('./play-BF1pKHkX.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BBcZlKoW.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-BdLBhdjQ.mjs')
  },
  {
    name: "editor",
    path: "/editor",
    component: () => import('./editor-Ce-GX0NM.mjs')
  },
  {
    name: "mypage",
    path: "/mypage",
    component: () => import('./mypage-Cm96yJc-.mjs')
  },
  {
    name: "rankings",
    path: "/rankings",
    component: () => import('./rankings-C5xUaw6Z.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-D9FBXC1B.mjs')
  },
  {
    name: "multiplayer",
    path: "/multiplayer",
    component: () => import('./multiplayer-DpfpOwrb.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-j58BfRxH.mjs').then((m) => m.default || m)),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dff28HNr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bm7UioDp.mjs'));
