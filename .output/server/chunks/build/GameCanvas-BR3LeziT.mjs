  ...
  setup(__props, { emit: __emit }) {
    ...
    const draw = () => {
      ...
      if (victory.value) {
        ...
        ctx.fillText(`SCORE: ${Math.floor(score.value)}`, w / 2, h / 2 + 20);
        ctx.restore();
        ...
        ctx.font = "700 30px Outfit";
        ctx.fillText(`${progressPct.value.toFixed(1)}%`, w / 2, h / 2 + 20);
        ctx.restore();
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "game-wrapper" }, _attrs))} data-v-2198081a><div class="game-container" data-v-2198081a><canvas width="1280" height="720" data-v-2198081a></canvas><div class="hud" data-v-2198081a><div class="hud-top-left" data-v-2198081a><div class="game-actions" data-v-2198081a>`);
      if (!__props.multiplayerMode && !__props.loadMap && isMapValidated.value && !hasSaved.value) {
        _push(`<button class="hud-action-btn save" data-v-2198081a> SAVE MAP </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="hud-action-btn exit" data-v-2198081a>나가기</button>`);
      if (__props.practiceMode && !gameOver.value) {
        _push(`<button class="hud-action-btn checkpoint" data-v-2198081a>SET CP (C)</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="title-container" data-v-2198081a><div class="${ssrRenderClass([{ inverted: isGravityInverted.value }, "wave-icon"])}" data-v-2198081a>▶</div>`);
      if (!__props.tutorialMode) {
        _push(`<h1 class="game-title" data-v-2198081a>ULTRA MUSIC MANIA</h1>`);
      } else {
        _push(`<h1 class="game-title tutorial" data-v-2198081a>TUTORIAL</h1>`);
      }
      _push(`</div><div class="progress-bar-container" data-v-2198081a><div class="progress-bar" style="${ssrRenderStyle({ width: progress.value + "%" })}" data-v-2198081a></div>`);
      if (bestProgress.value > 0) {
        _push(`<div class="best-record-marker" style="${ssrRenderStyle({ left: bestProgress.value + "%" })}" data-v-2198081a><div class="marker-line" data-v-2198081a></div><span class="marker-text" data-v-2198081a>BEST</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="progress-text" data-v-2198081a>${ssrInterpolate(Math.floor(progress.value))}%</span></div></div><div class="score-container" data-v-2198081a><div class="score-label" data-v-2198081a>SCORE</div><div class="score-val" data-v-2198081a>${ssrInterpolate(Math.floor(score.value))}</div></div><div class="speed-indicator" data-v-2198081a><span style="${ssrRenderStyle({ color: speedColor.value })}" data-v-2198081a>${ssrInterpolate(speedLabel.value)}</span>`);
      if (isMini.value) {
        _push(`<span class="mini-badge" data-v-2198081a>MINI</span>`);
      } else {
        _push(`<!---->`);
      }
      if (isMini.value) {
      ...
      if (isAutoplayUI.value && !__props.tutorialMode) {
        _push(`<span class="autoplay-badge" data-v-2198081a>AUTO MODE</span>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.tutorialMode) {
        _push(`<span class="autoplay-badge tutorial" data-v-2198081a>TUTORIAL</span>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.practiceMode) {
        _push(`<span class="autoplay-badge practice" data-v-2198081a>PRACTICE</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (gameOver.value) {
        _push(`<div class="status-overlay fail" data-v-2198081a><div class="status-content" data-v-2198081a><h1 class="status-text fail" data-v-2198081a>CRASHED</h1>`);
        if (isNewBest.value) {
          _push(`<p class="new-best-text" data-v-2198081a>🎉 NEW BEST! ${ssrInterpolate(progressPct.value)}%</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="status-sub" data-v-2198081a>${ssrInterpolate(failReason.value)}</p><div class="status-stats" data-v-2198081a><span data-v-2198081a>${ssrInterpolate(progressPct.value)}% PROGRESS</span><span class="stat-divider" data-v-2198081a>|</span><span data-v-2198081a>ATTEMPT ${ssrInterpolate(attempts.value)}</span></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (victory.value) {
        _push(`<div class="status-overlay win" data-v-2198081a><div class="status-content" data-v-2198081a><h1 class="status-text win" data-v-2198081a>COMPLETE!</h1><p class="status-sub" data-v-2198081a>모든 장애물을 돌파했습니다</p><div class="status-stats" data-v-2198081a><span data-v-2198081a>SCORE ${ssrInterpolate(Math.floor(score.value))}</span></div><div class="video-save-section" data-v-2198081a>`);
        if (!isRecordingSaved.value) {
          _push(`<button class="save-video-btn"${ssrIncludeBooleanAttr(isSavingVideo.value) ? " disabled" : ""} data-v-2198081a>`);
          if (isSavingVideo.value) {
            _push(`<span data-v-2198081a>💾 저장 중...</span>`);
          } else {
            _push(`<span data-v-2198081a>🎬 영상 저장</span>`);
          }
          _push(`</button>`);
        } else {
          _push(`<!---->`);
        ...
        if (isRecordingSaved.value) {
          _push(`<p class="save-success" data-v-2198081a>✅ 영상이 저장되었습니다!</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="save-hint" data-v-2198081a>클리어 장면을 동영상으로 저장합니다</p></div>`);
        if (__props.loadMap && __props.loadMap._id && !hasVoted.value) {
          _push(`<div class="rating-vote pointer-events-auto" data-v-2198081a><p class="rating-label" data-v-2198081a>RATE THIS MAP (1-30)</p><div class="rating-controls" data-v-2198081a><input type="range" min="1" max="30"${ssrRenderAttr("value", userRating.value)} class="rating-slider" data-v-2198081a><span class="rating-value" data-v-2198081a>${ssrInterpolate(userRating.value)}</span></div><button class="submit-rating-btn" data-v-2198081a>SUBMIT VOTE</button></div>`);
        } else if (hasVoted.value) {
          _push(`<div class="rating-done" data-v-2198081a> THANK YOU FOR VOTING! </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      if (countdown.value) {
        _push(`<div class="overlay countdown-overlay" data-v-2198081a><div class="countdown-text" data-v-2198081a>${ssrInterpolate(countdown.value)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isComputingPath.value && !gameOver.value && !victory.value) {
        _push(`<div class="validation-status" data-v-2198081a><div class="status-msg" data-v-2198081a>OPTIMIZING MAP...</div><div class="mini-progress" data-v-2198081a><div class="fill" style="${ssrRenderStyle({ width: computingProgress.value + "%" })}" data-v-2198081a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.practiceMode && checkpoints.value.length > 0) {
        _push(`<div class="checkpoint-indicator" data-v-2198081a> CPs: ${ssrInterpolate(checkpoints.value.length)} (Last: ${ssrInterpolate(Math.floor(checkpoints.value[checkpoints.value.length - 1].progress))}%) </div>`);
      } else {
        _push(`<!---->`);
      }
      if (!countdown.value && !gameOver.value && !victory.value && !isComputingPath.value) {
        _push(`<div class="controls-hint" data-v-2198081a><span data-v-2198081a>클릭/스페이스 유지 = 위로 | 해제 = 아래로</span>`);
        if (__props.practiceMode) {
          _push(`<span data-v-2198081a> | [C] 체크포인트 | [X] 최근 삭제</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-2198081a"]]), { __name: "GameCanvas" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=GameCanvas-BR3LeziT.mjs.map
