...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "game-wrapper" }, _attrs))} data-v-d47d29cf><div class="game-container" data-v-d47d29cf><canvas width="1280" height="720" data-v-d47d29cf></canvas><div class="hud" data-v-d47d29cf><div class="hud-top-left" data-v-d47d29cf><div class="game-actions" data-v-d47d29cf>`);
      if (!__props.multiplayerMode && !__props.loadMap && isMapValidated.value && !hasSaved.value) {
        _push(`<button class="hud-action-btn save" data-v-d47d29cf> SAVE MAP </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="hud-action-btn exit" data-v-d47d29cf>나가기</button><button class="hud-action-btn mode-change" data-v-d47d29cf>MODE</button>`);
      if (__props.practiceMode && !gameOver.value) {
        _push(`<button class="hud-action-btn checkpoint" data-v-d47d29cf>SET CP (C)</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="title-container" data-v-d47d29cf><div class="${ssrRenderClass([{ inverted: isGravityInverted.value }, "wave-icon"])}" data-v-d47d29cf>▶</div>`);
      if (!__props.tutorialMode) {
        _push(`<h1 class="game-title" data-v-d47d29cf>ULTRA MUSIC MANIA</h1>`);
      } else {
        _push(`<h1 class="game-title tutorial" data-v-d47d29cf>TUTORIAL</h1>`);
      }
      _push(`</div><div class="progress-bar-container" data-v-d47d29cf><div class="progress-bar" style="${ssrRenderStyle({ width: progress.value + "%" })}" data-v-d47d29cf></div>`);
      if (bestProgress.value > 0) {
        _push(`<div class="best-record-marker" style="${ssrRenderStyle({ left: bestProgress.value + "%" })}" data-v-d47d29cf><div class="marker-line" data-v-d47d29cf></div><span class="marker-text" data-v-d47d29cf>BEST</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="progress-text" data-v-d47d29cf>${ssrInterpolate(Math.floor(progress.value))}%</span></div></div><div class="score-container" data-v-d47d29cf><div class="score-label" data-v-d47d29cf>SCORE</div><div class="score-val" data-v-d47d29cf>${ssrInterpolate(Math.floor(score.value))}</div></div><div class="speed-indicator" data-v-d47d29cf><span style="${ssrRenderStyle({ color: speedColor.value })}" data-v-d47d29cf>${ssrInterpolate(speedLabel.value)}</span>`);
      if (isMini.value) {
        _push(`<span class="mini-badge" data-v-d47d29cf>MINI</span>`);
      } else {
        _push(`<!---->`);
      }
      if (isMini.value) {
      ...
      if (isAutoplayUI.value && !__props.tutorialMode) {
        _push(`<span class="autoplay-badge" data-v-d47d29cf>AUTO MODE</span>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.tutorialMode) {
        _push(`<span class="autoplay-badge tutorial" data-v-d47d29cf>TUTORIAL</span>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.practiceMode) {
        _push(`<span class="autoplay-badge practice" data-v-d47d29cf>PRACTICE</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (gameOver.value) {
        _push(`<div class="status-overlay fail" data-v-d47d29cf><div class="status-content" data-v-d47d29cf><h1 class="status-text fail" data-v-d47d29cf>CRASHED</h1>`);
        if (isNewBest.value) {
          _push(`<p class="new-best-text" data-v-d47d29cf>🎉 NEW BEST! ${ssrInterpolate(progressPct.value)}%</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="status-sub" data-v-d47d29cf>${ssrInterpolate(failReason.value)}</p><div class="status-stats" data-v-d47d29cf><span data-v-d47d29cf>${ssrInterpolate(progressPct.value)}% PROGRESS</span><span class="stat-divider" data-v-d47d29cf>|</span><span data-v-d47d29cf>ATTEMPT ${ssrInterpolate(attempts.value)}</span></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (victory.value) {
        _push(`<div class="status-overlay win" data-v-d47d29cf><div class="status-content" data-v-d47d29cf><h1 class="status-text win" data-v-d47d29cf>COMPLETE!</h1><p class="status-sub" data-v-d47d29cf>모든 장애물을 돌파했습니다</p><div class="status-stats" data-v-d47d29cf><span data-v-d47d29cf>SCORE ${ssrInterpolate(Math.floor(score.value))}</span></div><div class="video-save-section" data-v-d47d29cf>`);
        if (!isRecordingSaved.value) {
          _push(`<button class="save-video-btn"${ssrIncludeBooleanAttr(isSavingVideo.value) ? " disabled" : ""} data-v-d47d29cf>`);
          if (isSavingVideo.value) {
            _push(`<span data-v-d47d29cf>💾 저장 중...</span>`);
          } else {
            _push(`<span data-v-d47d29cf>🎬 영상 저장</span>`);
          }
          _push(`</button>`);
        } else {
          _push(`<!---->`);
        ...
        if (isRecordingSaved.value) {
          _push(`<p class="save-success" data-v-d47d29cf>✅ 영상이 저장되었습니다!</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="save-hint" data-v-d47d29cf>클리어 장면을 동영상으로 저장합니다</p></div>`);
        if (__props.loadMap && __props.loadMap._id && !hasVoted.value) {
          _push(`<div class="rating-vote pointer-events-auto" data-v-d47d29cf><p class="rating-label" data-v-d47d29cf>RATE THIS MAP (1-30)</p><div class="rating-controls" data-v-d47d29cf><input type="range" min="1" max="30"${ssrRenderAttr("value", userRating.value)} class="rating-slider" data-v-d47d29cf><span class="rating-value" data-v-d47d29cf>${ssrInterpolate(userRating.value)}</span></div><button class="submit-rating-btn" data-v-d47d29cf>SUBMIT VOTE</button></div>`);
        } else if (hasVoted.value) {
          _push(`<div class="rating-done" data-v-d47d29cf> THANK YOU FOR VOTING! </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      if (countdown.value) {
        _push(`<div class="overlay countdown-overlay" data-v-d47d29cf><div class="countdown-text" data-v-d47d29cf>${ssrInterpolate(countdown.value)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isComputingPath.value && !gameOver.value && !victory.value) {
        _push(`<div class="validation-status" data-v-d47d29cf><div class="status-msg" data-v-d47d29cf>OPTIMIZING MAP...</div><div class="mini-progress" data-v-d47d29cf><div class="fill" style="${ssrRenderStyle({ width: computingProgress.value + "%" })}" data-v-d47d29cf></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.practiceMode && checkpoints.value.length > 0) {
        _push(`<div class="checkpoint-indicator" data-v-d47d29cf> CPs: ${ssrInterpolate(checkpoints.value.length)} (Last: ${ssrInterpolate(Math.floor(checkpoints.value[checkpoints.value.length - 1].progress))}%) </div>`);
      } else {
        _push(`<!---->`);
      }
      if (!countdown.value && !gameOver.value && !victory.value && !isComputingPath.value) {
        _push(`<div class="controls-hint" data-v-d47d29cf>`);
        if (__props.tutorialMode && activeTutorialMessage.value) {
          _push(`<div class="tutorial-message-bubble" data-v-d47d29cf>${ssrInterpolate(activeTutorialMessage.value)}</div>`);
        } else {
          _push(`<div data-v-d47d29cf><span data-v-d47d29cf>클릭/스페이스 유지 = 위로 | 해제 = 아래로</span>`);
          if (__props.practiceMode) {
            _push(`<span data-v-d47d29cf> | [C] 체크포인트 | [X] 최근 삭제</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-d47d29cf"]]), { __name: "GameCanvas" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=GameCanvas-DYNPGhAt.mjs.map
