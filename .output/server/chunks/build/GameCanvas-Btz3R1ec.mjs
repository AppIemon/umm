...
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderAttr } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "game-wrapper" }, _attrs))} data-v-169728f8><div class="game-container" data-v-169728f8><canvas width="1280" height="720" data-v-169728f8></canvas><div class="hud" data-v-169728f8><div class="hud-top-left" data-v-169728f8><div class="game-actions" data-v-169728f8>`);
      if (!__props.multiplayerMode) {
        _push(`<button${ssrIncludeBooleanAttr(!isMapValidated.value) ? " disabled" : ""} class="${ssrRenderClass([{ disabled: !isMapValidated.value }, "hud-action-btn tutorial"])}" data-v-169728f8>${ssrInterpolate(isMapValidated.value ? "TUTORIAL" : "VALIDATING...")}</button>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.multiplayerMode && !__props.loadMap && isMapValidated.value && !hasSaved.value) {
        _push(`<button class="hud-action-btn save" data-v-169728f8> SAVE MAP </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="hud-action-btn exit" data-v-169728f8>나가기</button></div><div class="title-container" data-v-169728f8><div class="${ssrRenderClass([{ inverted: isGravityInverted.value }, "wave-icon"])}" data-v-169728f8>▶</div><h1 class="game-title" data-v-169728f8>ULTRA MUSIC MANIA</h1></div><div class="progress-bar-container" data-v-169728f8><div class="progress-bar" style="${ssrRenderStyle({ width: progress.value + "%" })}" data-v-169728f8></div>`);
      if (bestProgress.value > 0) {
        _push(`<div class="best-record-marker" style="${ssrRenderStyle({ left: bestProgress.value + "%" })}" data-v-169728f8><div class="marker-line" data-v-169728f8></div><span class="marker-text" data-v-169728f8>BEST</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="progress-text" data-v-169728f8>${ssrInterpolate(Math.floor(progress.value))}%</span></div></div><div class="score-container" data-v-169728f8><div class="score-label" data-v-169728f8>SCORE</div><div class="score-val" data-v-169728f8>${ssrInterpolate(Math.floor(score.value))}</div></div><div class="speed-indicator" data-v-169728f8><span style="${ssrRenderStyle({ color: speedColor.value })}" data-v-169728f8>${ssrInterpolate(speedLabel.value)}</span>`);
      if (isMini.value) {
        _push(`<span class="mini-badge" data-v-169728f8>MINI</span>`);
      } else {
        _push(`<!---->`);
      }
      if (isAutoplayUI.value) {
        _push(`<span class="autoplay-badge" data-v-169728f8>TUTORIAL MODE</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (gameOver.value) {
        _push(`<div class="status-overlay fail" data-v-169728f8><div class="status-content" data-v-169728f8><h1 class="status-text fail" data-v-169728f8>CRASHED</h1><p class="status-sub" data-v-169728f8>${ssrInterpolate(failReason.value)}</p><div class="status-stats" data-v-169728f8><span data-v-169728f8>${ssrInterpolate(progressPct.value)}% PROGRESS</span><span class="stat-divider" data-v-169728f8>|</span><span data-v-169728f8>ATTEMPT ${ssrInterpolate(attempts.value)}</span></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (victory.value) {
        _push(`<div class="status-overlay win" data-v-169728f8><div class="status-content" data-v-169728f8><h1 class="status-text win" data-v-169728f8>COMPLETE!</h1><p class="status-sub" data-v-169728f8>모든 장애물을 돌파했습니다</p><div class="status-stats" data-v-169728f8><span data-v-169728f8>SCORE ${ssrInterpolate(Math.floor(score.value))}</span></div>`);
        if (__props.loadMap && __props.loadMap._id && !hasVoted.value) {
          _push(`<div class="rating-vote pointer-events-auto" data-v-169728f8><p class="rating-label" data-v-169728f8>RATE THIS MAP (1-30)</p><div class="rating-controls" data-v-169728f8><input type="range" min="1" max="30"${ssrRenderAttr("value", userRating.value)} class="rating-slider" data-v-169728f8><span class="rating-value" data-v-169728f8>${ssrInterpolate(userRating.value)}</span></div><button class="submit-rating-btn" data-v-169728f8>SUBMIT VOTE</button></div>`);
        } else if (hasVoted.value) {
          _push(`<div class="rating-done" data-v-169728f8> THANK YOU FOR VOTING! </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      if (countdown.value) {
        _push(`<div class="overlay countdown-overlay" data-v-169728f8><div class="countdown-text" data-v-169728f8>${ssrInterpolate(countdown.value)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isComputingPath.value && !gameOver.value && !victory.value) {
        _push(`<div class="validation-status" data-v-169728f8><div class="status-msg" data-v-169728f8>OPTIMIZING MAP...</div><div class="mini-progress" data-v-169728f8><div class="fill" style="${ssrRenderStyle({ width: computingProgress.value + "%" })}" data-v-169728f8></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!countdown.value && !gameOver.value && !victory.value && !isComputingPath.value) {
        _push(`<div class="controls-hint" data-v-169728f8><span data-v-169728f8>클릭/스페이스 유지 = 위로 | 해제 = 아래로</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-169728f8"]]), { __name: "GameCanvas" });

export { __nuxt_component_0 as _, setInterval as s };
//# sourceMappingURL=GameCanvas-Btz3R1ec.mjs.map
