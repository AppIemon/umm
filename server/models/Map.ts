...
export interface IMap extends Document {
  ...
  audioData: string | null // 노래 파일 데이터 (Base64) - 4.5MB 이하 (DEPRECATED)
  audioChunks: string[]    // 4.5MB씩 분할된 오디오 데이터 청크 (DEPRECATED)
  audioContentId: Types.ObjectId | null // 오디오 콘텐츠 참조 (최적화용)
  bpm: number
