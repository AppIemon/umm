declare global {
  ...
  const connectDB: typeof import('../../server/utils/db').connectDB
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'F:/내가 왜 박치임/impossibletiming/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'F:/내가 왜 박치임/impossibletiming/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { connectDB } from 'F:/내가 왜 박치임/impossibletiming/server/utils/db';